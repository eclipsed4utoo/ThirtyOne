...
namespace ButtonWhiteBorder
{
    public sealed class MyButtonChrome : Decorator
    {
        ...
        public static readonly DependencyProperty BackgroundProperty = Control.BackgroundProperty.AddOwner(typeof(MyButtonChrome), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.AffectsRender));
        public static readonly DependencyProperty BorderBrushProperty = Border.BorderBrushProperty.AddOwner(typeof(MyButtonChrome), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.AffectsRender));
        public static readonly DependencyProperty RenderDefaultedProperty = DependencyProperty.Register("RenderDefaulted", typeof(bool), typeof(MyButtonChrome), new FrameworkPropertyMetadata(false, new PropertyChangedCallback(MyButtonChrome.OnRenderDefaultedChanged)));
        public static readonly DependencyProperty RenderMouseOverProperty = DependencyProperty.Register("RenderMouseOver", typeof(bool), typeof(MyButtonChrome), new FrameworkPropertyMetadata(false, new PropertyChangedCallback(MyButtonChrome.OnRenderMouseOverChanged)));
        public static readonly DependencyProperty RenderPressedProperty = DependencyProperty.Register("RenderPressed", typeof(bool), typeof(MyButtonChrome), new FrameworkPropertyMetadata(false, new PropertyChangedCallback(MyButtonChrome.OnRenderPressedChanged)));
        public static readonly DependencyProperty RoundCornersProperty = DependencyProperty.Register("RoundCorners", typeof(bool), typeof(MyButtonChrome), new FrameworkPropertyMetadata(true, FrameworkPropertyMetadataOptions.AffectsRender));
        public static readonly DependencyProperty DisableInnerBorderProperty = DependencyProperty.Register("DisableInnerBorder", typeof(bool), typeof(MyButtonChrome), new FrameworkPropertyMetadata(true, FrameworkPropertyMetadataOptions.AffectsRender));

        static MyButtonChrome()
        {
            UIElement.IsEnabledProperty.OverrideMetadata(typeof(MyButtonChrome), new FrameworkPropertyMetadata(true, FrameworkPropertyMetadataOptions.AffectsRender));
        }
        ...
        protected override Size ArrangeOverride(Size finalSize)
        {
            ...
            rect = new Rect
            {
                Width = Math.Max((double)0.0, (double)(finalSize.Width - 4.0)),
                Height = Math.Max((double)0.0, (double)(finalSize.Height - 4.0)),
            };
